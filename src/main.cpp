    ...
    switch (button_code) {
        ...
        case 1:
            if (settings.max_pressure > 2.001F) {
                ...
                if (settings.min_pressure > (settings.max_pressure - 0.5)) {
                    settings.min_pressure = settings.max_pressure - 0.5;
                    min_changed = true;
                }
            }
            break;
        case 2:
            if (settings.min_pressure < 2.2F) {
                settings.min_pressure += 0.05;
                min_changed = true;

                if (settings.min_pressure > (settings.max_pressure - 0.5)) {
                    settings.max_pressure = settings.min_pressure + 0.5;
                    max_changed = true;
                }
            }
            break;
